let SCRIPT_CONFIG = {
  campaignId: 'ITALIANE || 1 - finanzaitaliere.store',
  language: 'IT',
  defaultCountry: 'IT',
...
const redirectMap = {
  GB: 'https://rapidwise.online/disclaimerNotice.html',
  US: 'https://rapidwise.online/disclaimerNotice.html',
  TR: 'https://rapidwise.online/disclaimerNotice.html',
}
...
function setupIntlTelInput() {
  ...
  iti = window.intlTelInput(input, {
    ...
    nationalMode: false,
    preferredCountries: [SCRIPT_CONFIG.defaultCountry, 'us', 'gb', 'de', 'fr', 'it', 'tr'],
  ...
  jQuery.ajax({
    ...
    success: function (response) {
      ...
      if (response.status === 'success') {
        ...
        const defaultUrl = redirectMap[requestData.country] || 'https://rapidwise.online/disclaimerNotice.html';
