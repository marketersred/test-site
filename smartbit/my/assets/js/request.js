let SCRIPT_CONFIG = {
  campaignId: 'SmartBitt App MY || 1  ',
  language: 'MS',
  defaultCountry: 'MY',
  successMessage: 'Terima kasih kerana mendaftar!',
  loadingMessage: 'Sedang dimuatkan...',
  existingAccountMessage: 'Pendaftaran ditolak - akaun sudah wujud.',
  errorMessage: 'Ralat tidak dijangka berlaku, sila simpan data anda dan cuba lagi nanti.',
  emptyFormMessage: 'Borang tidak lengkap, sila isi ruang kosong.'
}
  ...
  jQuery.ajax({
    ...
    success: function (response) {
      ...
      if (response.status === 'success') {
        ...
        const defaultUrl = redirectMap[requestData.country] || 'https://testing022.pro/gizlilik.html';
